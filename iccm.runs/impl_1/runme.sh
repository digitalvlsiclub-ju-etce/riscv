...
HD_PWD='C:/Users/maham/verilog/iccm/iccm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fetch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fetch.tcl -notrace
